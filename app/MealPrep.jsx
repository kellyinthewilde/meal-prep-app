...
const COOK_PLAN = [
  {
    ...
    recipes: [
      ...
      { id: 83, note: "Stove 10 min. All 4 batches (16 cups berries). Freeze in ½-cup Souper Cubes. Topping for congee/pudding." },
      { id: 85, note: "Stove 10 min. 1 batch (4 cups cherries). Freeze in ½-cup Souper Cubes. Amazing over Date & Walnut Congee." },
      { id: 86, note: "Stove 10 min. 1 batch (4 cups mango). Freeze in ½-cup Souper Cubes." },
      { id: 84, note: "Stove 10 min + blend. Both batches (8 cups mango). Freeze in 1-cup Souper Cubes." },
      { id: 88, note: "Stove 10 min + chia thicken. Both batches. Freeze in 2-tbsp Souper Cubes. Jam for toast/oatmeal." },
      { id: 87, note: "Oven 25 min. Both batches (32 squares). Freeze wrapped in parchment." },
      { id: 89, note: "Stove 20 min. Both batches. Mango folded into coconut rice. Freeze in 1-cup Souper Cubes." },
      { id: 90, note: "Stove 15 min. 1 batch. Savory chutney for curries. Freeze in ½-cup Souper Cubes." },
    ],
  },
  {
    id: "B",
...
const RECIPES = [
  ...
  // ─── BLOCK 2: Hearty Meals & Phase 2 ───
  {
    ...
    instructions: [
      ...
      "Stir in cream, simmer on low 5 min",
  ...
  },
  {
    ...
    instructions: [
      ...
      "Stir in coconut milk, simmer 5 min on low",
      "Season with salt and lime",
    ],
    yield: "~10 portions",
  ...
  },
  {
    ...
    instructions: [
      "Combine frozen mango, water, honey, and ginger in a saucepan",
      "STOVE: Simmer over medium heat 8-10 min, stirring, until mango softens and breaks down",
      "Mash lightly with a fork for chunky texture (or blend smooth if preferred)",
      "Stir in cardamom and lime juice if using",
      "Cool slightly, pour into ½-cup Souper Cube molds",
    ],
    yield: "~8-10 half-cup portions.",
    freezing: "Freeze in ½-cup Souper Cubes. Each cube = one topping portion. Reheat in small pot.",
    note: "TOPPING. Simpler than the lassi — no coconut milk. Tropical, gingery, and warming. Great over Rice Pudding or congee.",
  },
  {
    id: 87,
  ...
  },
  {
    ...
    instructions: [
      "Cook rice: combine rice, coconut milk, water, and salt in pot",
      "STOVE: Bring to boil, reduce to simmer, cover 15 min. Fluff.",
      "While rice cooks, simmer frozen mango with honey and cardamom in a separate pan 5-8 min until soft",
      "Mash mango lightly with a fork (keep chunky)",
      "Fold warm mango into cooked rice",
      "Cool, portion into 1-cup Souper Cubes",
    ],
    yield: "~8-10 one-cup portions per batch.",
    freezing: "Freeze in 1-cup Souper Cubes. Reheat in pot with a splash of coconut milk. Sweet side dish for any curry.",
    note: "SIDE DISH. Coconut rice with warm mango stirred through. Pairs beautifully with Butter Chicken, Chickpea Curry, or Coconut Dal. Comfort food.",
  },
  {
    id: 90,
