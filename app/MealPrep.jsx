...
const RECIPES = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      "28 oz crushed tomatoes",
      "1.25 cups dried kidney beans // Soak overnight. IP: 25 min high pressure, natural release. Cook before adding to chili.",
      "0.75 cup dried black beans // Soak overnight with kidneys. Same cook time. ~1 can equivalent.",
      "2 tbsp tomato paste",
      "1 tbsp grated dark chocolate // Melts in, adds depth. Replaces cocoa powder.",
      "Salt, pepper",
    ],
    instructions: [
      "BEANS FIRST: Soak kidney + black beans overnight. IP: HIGH pressure 25 min, natural release. Drain and set aside.",
