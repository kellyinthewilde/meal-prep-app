...
const COOK_PLAN = [
  {
    ...
    recipes: [
      ...
      { id: 83, note: "Stove 10 min. Both batches (8 cups berries). Freeze in ½-cup Souper Cubes. Topping for congee/pudding." },
...
const RECIPES = [
  ...
  // ─── Frozen Fruit Recipes (Phase A) ───
  {
    ...
    batchCount: 2,
    ingredients: [
      "4 cups frozen mixed berries // 1 Costco bag",
      "3 tbsp honey",
      "1 tsp cinnamon",
    ...
    yield: "~8-10 half-cup portions per batch (2 batches = 16-20 cubes total)",
