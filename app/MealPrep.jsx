...
const COOK_PLAN = [
  {
    ...
    recipes: [
      ...
      { id: 83, note: "Stove 10 min. Both batches. Freeze in ½-cup Souper Cubes. Topping for congee/pudding." },
      { id: 84, note: "Stove 10 min + blend. Both batches. Freeze in 1-cup Souper Cubes." },
    ],
  },
  {
    id: "B",
