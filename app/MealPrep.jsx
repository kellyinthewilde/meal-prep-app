...
// ── 42-DAY PLAN DATA ──
const PLAN_DATA = {weeks:[{title:"Week 1",notes:["DAYS 1-3: Acute recovery. Massive hormone drop. Iron + protein critical. Warm, easy-to-digest meals. Broth sipping throughout the day.","DAYS 3-5: Baby blues window. Milk coming in. Omega-3s + B vitamins for mood. Caloric needs climbing.","DAYS 5-10: FIRST GROWTH SPURT. Cluster feeding begins. Hunger surges. Calorie-dense meals. Your body suppresses appetite regulation \u2014 eat on demand."],days:[{day:1,description:"Birth day. Gentle, warming. Miyeokguk is THE Korean recovery soup \u2014 iron-rich seaweed + beef. Sweet congee for Kelly healing breakfast.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Beef & Sweet Potato Stew"},{slot:"Dinner",kelly:"Chicken Ginger Congee",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:2,description:"Iron rebuilding. Silkie tonic for blood replenishment. Congee breakfast for postpartum healing.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Sweet Congee (Chai)",jonny:"White Chicken Chili"},{slot:"Dinner",kelly:"Carrot Ginger Soup",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:3,description:"Day 3: Hormone crash. Milk transitioning. Beef stew for iron. Don\u2019t hold back on hearty food if craving it.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"(same)"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Beef Chili"},{slot:"Dinner",kelly:"Beef & Sweet Potato Stew",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:4,description:"Day 4: Baby blues peak. Salmon for omega-3s \u2014 directly supports mood. B vitamins from egg-based breakfast.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"(same)"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"Bolognese + Meatballs"},{slot:"Dinner",kelly:"Salmon Patties + Rice",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:5,description:"Day 5: Milk fully in. Engorgement. Caloric needs climbing. Chili brings iron + protein + calories.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Date & Walnut Congee",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Sweet Congee (Chai)",jonny:"Date & Walnut Congee"},{slot:"Dinner",kelly:"Beef Chili",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:6,description:"Building toward growth spurt. Calorie-dense dinner. Carrot ginger soup as breakfast.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Carrot Ginger Soup",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Sweet Potato Coconut Soup",jonny:"(same)"},{slot:"Dinner",kelly:"White Chicken Chili",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:7,description:"DAY 7: Growth spurt likely starting. Cluster feeding. Hunger surges. Bolognese + meatballs for calorie density.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"Beef & Sweet Potato Stew"},{slot:"Dinner",kelly:"Bolognese + Meatballs",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]}]},{title:"Week 2",notes:["DAYS 5-10: FIRST GROWTH SPURT continues.","WEEKS 2-3: Second growth spurt. Sustained elevated appetite. Cumulative sleep deprivation peaks. Nutrient density critical."],days:[{day:8,description:"Growth spurt day 2. Cluster feeding. Eat on demand \u2014 your body needs it.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"(same)"},{slot:"Lunch",kelly:"Chicken Ginger Congee",jonny:"(same)"},{slot:"Dinner",kelly:"Moroccan Beef Stew",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:9,description:"Growth spurt peak. Butter chicken = protein + healthy fat. Extra snacks encouraged.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Kabocha & Mung Bean Soup",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Beef & Sweet Potato Stew",jonny:"Kitchari"},{slot:"Dinner",kelly:"Butter Chicken + Rice",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:10,description:"Growth spurt easing. Dal is warming, easy to digest, protein-rich.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"(same)"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Coconut Mung Bean Dal + Rice",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:11,description:"Between growth spurts. Building reserves. Sweet congee for Kelly, kitchari for Jonny (uses surplus).",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"Kitchari"},{slot:"Dinner",kelly:"Chickpea Curry + Rice",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:12,description:"Kitchari = Ayurvedic reset. Gentle on digestion, deeply nourishing.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"(same)"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Black Bean Soup"},{slot:"Dinner",kelly:"Kitchari",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:13,description:"Comfort food night. Pot pie = warm hug in a bowl.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Quiche (\u00d72 sl.)"},{slot:"Lunch",kelly:"Minestrone + Meatballs",jonny:"(same)"},{slot:"Dinner",kelly:"Chicken Pot Pie",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:14,description:"Loading iron before week 2-3 growth spurt. Last day of silkie tonic daily schedule.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Oatmeal Bowl + Compote",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Carrot Ginger Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Beef Chili",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]}]},{title:"Week 3",notes:["WEEKS 2-3: Second growth spurt. Sustained elevated appetite. Sleep deprivation peaks.","WEEK 3-4: THE CRISIS WINDOW. Highest PPD/PPA risk. Iron, protein, B vitamins, choline all mood-supporting."],days:[{day:15,description:"Week 3 growth spurt window. Calorie-dense dinner. Nutrient density matters. Smoothie for Jonny \u2014 using up frozen berries.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Chicken Ginger Congee",jonny:"Moroccan Beef Stew"},{slot:"Dinner",kelly:"Butter Chicken + Rice",jonny:"(same)"}]},{day:16,description:"Black bean soup \u2014 protein, fiber, iron. Easy on digestion.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Date & Walnut Congee",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Black Bean Soup",jonny:"(same)"}]},{day:17,description:"Miyeokguk for Kelly\u2019s iron. Dal for dinner \u2014 warming and protein-rich.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Kabocha & Mung Bean Soup",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Minestrone + Meatballs"},{slot:"Dinner",kelly:"Coconut Mung Bean Dal + Rice",jonny:"(same)"}]},{day:18,description:"Iron + protein focus. Hidden liver in the chili = stealth nutrition.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Date & Walnut Congee",jonny:"(same)"},{slot:"Dinner",kelly:"Beef Chili",jonny:"(same)"}]},{day:19,description:"Chickpea curry \u2014 plant protein + iron. Good variety from beef-heavy earlier days.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Date & Walnut Congee",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Sweet Potato Coconut Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Chickpea Curry + Rice",jonny:"(same)"}]},{day:20,description:"Salmon = omega-3 for mood support. Week 3 is highest PPD risk window.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Minestrone + Meatballs",jonny:"(same)"},{slot:"Dinner",kelly:"Salmon Patties + Rice",jonny:"(same)"}]},{day:21,description:"Heading into week 3-4 crisis. Moroccan stew is iron + protein dense.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Oatmeal Bowl + Compote",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Carrot Ginger Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Moroccan Beef Stew",jonny:"(same)"}]}]},{title:"Week 4",notes:["WEEK 3-4: THE CRISIS WINDOW. Highest PPD/PPA risk. Growth spurt + sleep debt + hormonal low. Iron, protein, B vitamins, choline all mood-supporting."],days:[{day:22,description:"Crisis window. Beef stew = iron + B12 + comfort. Choline-rich breakfast.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"(same)"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Beef & Sweet Potato Stew",jonny:"(same)"}]},{day:23,description:"Iron-rich lunch for Kelly. Butter chicken for protein-dense dinner.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Coconut Mung Bean Dal + Rice"},{slot:"Dinner",kelly:"Butter Chicken + Rice",jonny:"(same)"}]},{day:24,description:"Eggs for choline. White chili for protein.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"(same)"},{slot:"Lunch",kelly:"Chicken Ginger Congee",jonny:"Minestrone + Meatballs"},{slot:"Dinner",kelly:"White Chicken Chili",jonny:"(same)"}]},{day:25,description:"Kitchari for digestive reset amid the intensity.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Minestrone + Meatballs",jonny:"(same)"},{slot:"Dinner",kelly:"Kitchari",jonny:"(same)"}]},{day:26,description:"Salmon again \u2014 omega-3 is your best nutritional ally for mood right now.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Carrot Ginger Soup",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Beef Chili",jonny:"(same)"},{slot:"Dinner",kelly:"Salmon Patties + Rice",jonny:"(same)"}]},{day:27,description:"Hidden liver in bolognese = stealth iron + B12. The body doesn\u2019t know, but it benefits.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Oatmeal Bowl + Compote",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Chicken Pot Pie",jonny:"(same)"},{slot:"Dinner",kelly:"Bolognese + Meatballs",jonny:"(same)"}]},{day:28,description:"Closing the crisis window. Hormones beginning to rise. You\u2019re through the hardest part.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Date & Walnut Congee",jonny:"(same)"},{slot:"Dinner",kelly:"Chickpea Curry + Rice",jonny:"(same)"}]}]},{title:"Week 5",notes:["WEEKS 5-6: Stabilization. Hormones rising. Feeding patterns more predictable. Full variety. Still +400 cal/day for breastfeeding."],days:[{day:29,description:"Stabilization phase. Appetite still elevated but less desperate.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Beef & Sweet Potato Stew",jonny:"(same)"}]},{day:30,description:"Stabilization. Congee + black bean for Kelly surpluses.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Date & Walnut Congee",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Coconut Mung Bean Dal + Rice",jonny:"(same)"}]},{day:31,description:"Stabilization. Kabocha soup breakfast for Kelly.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Kabocha & Mung Bean Soup",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Chicken Ginger Congee",jonny:"(same)"},{slot:"Dinner",kelly:"Minestrone + Meatballs",jonny:"(same)"}]},{day:32,description:"Oatmeal breakfast for Kelly.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Oatmeal Bowl + Compote",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Butter Chicken + Rice",jonny:"(same)"}]},{day:33,description:"Stabilization phase.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Moroccan Beef Stew",jonny:"(same)"},{slot:"Dinner",kelly:"White Chicken Chili",jonny:"(same)"}]},{day:34,description:"Sweet congee + minestrone for Kelly, chickpea curry for Jonny surplus.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Minestrone + Meatballs",jonny:"Chickpea Curry + Rice"},{slot:"Dinner",kelly:"Chicken Pot Pie",jonny:"(same)"}]},{day:35,description:"Date congee + sweet congee for Kelly.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Date & Walnut Congee",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Sweet Congee (Chai)",jonny:"(same)"},{slot:"Dinner",kelly:"Beef Chili",jonny:"(same)"}]}]},{title:"Week 6",notes:["WEEKS 5-6: Stabilization. Hormones rising. Feeding patterns more predictable. Full variety. Still +400 cal/day for breastfeeding."],days:[{day:36,description:"Week 6 growth spurt possible around now.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Kitchari",jonny:"(same)"}]},{day:37,description:"Oatmeal breakfast for Kelly.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Oatmeal Bowl + Compote",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Coconut Mung Bean Dal + Rice",jonny:"(same)"},{slot:"Dinner",kelly:"Moroccan Beef Stew",jonny:"(same)"}]},{day:38,description:"Stabilization phase.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Chickpea Curry + Rice",jonny:"(same)"}]},{day:39,description:"Congee + black bean for Kelly.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Berry Smoothie"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Bolognese + Meatballs",jonny:"(same)"}]},{day:40,description:"Quiche breakfast for Kelly.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"Berry Smoothie"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Chicken Pot Pie"},{slot:"Dinner",kelly:"Salmon Patties + Rice",jonny:"(same)"}]},{day:41,description:"Frittata breakfast for Kelly.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"Berry Smoothie"},{slot:"Lunch",kelly:"White Chicken Chili",jonny:"(same)"},{slot:"Dinner",kelly:"Beef Chili",jonny:"(same)"}]},{day:42,description:"Day 42. Six weeks postpartum. You made it.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"Berry Smoothie"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"Black Bean Soup"},{slot:"Dinner",kelly:"Butter Chicken + Rice",jonny:"(same)"}]}]}]};

// ── MEAL PAIRINGS (what to freeze alongside each meal) ──
const MEAL_PAIRINGS = {
  "Butter Chicken + Rice": "Pack with: 1 frozen rice portion (½ cup)",
  "Chickpea Curry + Rice": "Pack with: 1 frozen rice portion (½ cup)",
  "Coconut Mung Bean Dal + Rice": "Pack with: 1 frozen rice portion (½ cup)",
  "Salmon Patties + Rice": "Pack with: 1 frozen rice portion (½ cup). Reheat patties in skillet or toaster oven.",
  "Bolognese + Meatballs": "Pack with: 1 frozen rice portion (½ cup) OR cook pasta fresh. No extra meatballs needed — sauce already has ground beef + hidden liver.",
  "Minestrone + Meatballs": "Pack soup + meatballs together (reserve meatballs for minestrone, not bolognese). Cook pasta fresh when serving.",
  "Oatmeal Bowl + Compote": "Pack with: 1 compote portion. Reheat oatmeal with splash of milk.",
  "Chicken Pot Pie": "Filling only in freezer. Bake puff pastry on top fresh (400°F, 20-25 min).",
  "Kitchari": "Complete meal — no side needed. Already has rice + lentils.",
  "Beef Chili": "Standalone. Optional: serve with rice or tortilla chips.",
...
const getPairingsForDay = (meals) => {
  ...
  const seen = new Set();
  meals.forEach((m) => {
    [m.kelly, m.jonny].forEach((meal) => {
      if (meal && meal !== "(same)" && meal !== "\u2014" && MEAL_PAIRINGS[meal] && !seen.has(meal)) {
        seen.add(meal);
        pairings.push({ meal, note: MEAL_PAIRINGS[meal] });
      }
    });
  });
  return pairings;
      ...
      {currentTab === "42-Day Plan" && (() => {
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-4">
            ...
            <p className="text-sm text-gray-500">Kelly &amp; Jonny Miller</p>
            ...
            <div key={week.title} className="space-y-3">
              <div className="sticky top-0 z-10 bg-gradient-to-r from-amber-50 to-rose-50 rounded-lg px-4 py-3 border border-amber-200 shadow-sm">
                <div className="flex items-center justify-between">
                  <h3 className="font-bold text-amber-900">{week.title}</h3>
                  <span className="text-xs font-medium text-amber-700">{weekAssembled}/{weekDays.length} assembled</span>
                </div>
                ...
                <div key={day.day} className={`rounded-lg shadow-sm border overflow-hidden transition-all duration-300 ${isAssembled ? 'bg-gray-50 border-gray-200 opacity-60' : 'bg-white border-gray-100'}`}>
                  ...
                  <div className="divide-y divide-gray-50">
                    {day.meals.filter(m => m.slot !== "AM Broth" && m.slot !== "PM Sip").map((meal) => {
                      ...
                      return (
                        <div key={meal.slot} className="px-4 py-2 flex items-start gap-3">
                          <span className={`text-xs font-semibold uppercase tracking-wider w-16 pt-0.5 shrink-0 ${isAssembled ? 'text-gray-300' : 'text-gray-400'}`}>{meal.slot === "Breakfast" ? "Bkfst" : meal.slot}</span>
                          {isSame ? (
                            <div className="flex items-center gap-2">
                              <span className={`w-2 h-2 rounded-full shrink-0 mt-1 ${isAssembled ? 'bg-gray-300' : 'bg-amber-400'}`} />
                              <span className={`text-sm ${isAssembled ? 'text-gray-400 line-through' : 'text-gray-800'}`}>{meal.kelly}</span>
                            </div>
                          ) : isKellyOnly ? (
                            <div className="flex items-center gap-2">
                              <span className={`w-2 h-2 rounded-full shrink-0 mt-1 ${isAssembled ? 'bg-gray-300' : 'bg-pink-400'}`} />
                              <span className={`text-sm ${isAssembled ? 'text-gray-400 line-through' : 'text-gray-800'}`}>{meal.kelly}</span>
                            </div>
                          ) : (
                            <div className="flex flex-col sm:flex-row sm:gap-4 gap-1 flex-1">
                              <div className="flex items-center gap-2">
                                <span className={`w-2 h-2 rounded-full shrink-0 mt-0.5 ${isAssembled ? 'bg-gray-300' : 'bg-pink-400'}`} />
                                <span className={`text-sm ${isAssembled ? 'text-gray-400 line-through' : 'text-gray-800'}`}>{meal.kelly}</span>
                              </div>
                              <div className="flex items-center gap-2">
                                <span className={`w-2 h-2 rounded-full shrink-0 mt-0.5 ${isAssembled ? 'bg-gray-300' : 'bg-blue-400'}`} />
                                <span className={`text-sm ${isAssembled ? 'text-gray-400 line-through' : 'text-gray-600'}`}>{meal.jonny}</span>
                              </div>
                            </div>
                          )}
                        </div>
                    ...
                    {(() => {
                      ...
                      return (
                        <div className={`px-4 py-1.5 bg-gray-50/50 flex items-center gap-3 text-xs ${isAssembled ? 'text-gray-300' : 'text-gray-400'}`}>
                          <span className={`w-2 h-2 rounded-full shrink-0 ${isAssembled ? 'bg-gray-200' : 'bg-gray-300'}`} />
                    ...
                    {/* Freezer pairings */}
                    {!isAssembled && (() => {
                      const pairings = getPairingsForDay(day.meals);
                      if (pairings.length === 0) return null;
                      return (
                        <div className="px-4 py-2.5 bg-indigo-50/60 border-t border-indigo-100">
                          <div className="flex items-center gap-1.5 mb-1.5">
                            <svg className="w-3.5 h-3.5 text-indigo-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
                            <span className="text-xs font-semibold text-indigo-700">Freezer Pairings</span>
                          </div>
                          {pairings.map((p) => (
                            <p key={p.meal} className="text-xs text-indigo-600 leading-relaxed ml-5">
                              <span className="font-medium">{p.meal}:</span> {p.note.replace(/^Pack with: |^/, '')}
                            </p>
                          ))}
                        </div>
                      );
