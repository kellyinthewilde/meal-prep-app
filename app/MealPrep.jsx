...
const RECIPES = [
  ...
  },
  {
    ...
    instructions: [
      "Roast squash cut-side down 400-425F for 45 min until fork-tender",
      "Scoop flesh out, discard skin",
      "Sauté onion in ghee 3-4 min until soft (IP: use Sauté mode)",
      "Add garlic + ginger, cook 1 min",
      "Add cumin, turmeric, coriander, cinnamon — stir 30 sec until fragrant",
      "Add squash flesh, lentils, broth",
      "STOVE: Bring to boil then simmer 20-25 min until lentils dissolve",
      "IP: Cancel Sauté, HIGH pressure 5 min, quick release",
      "Blend until smooth (immersion blender or regular blender in batches)",
      "Stir in coconut milk, season with salt and lime",
    ],
    yield: "~10 two-cup portions per batch. Make 2 batches (20 portions for Weeks 1-4).",
