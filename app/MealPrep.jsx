...
const COOK_PLAN = [
  {
    ...
    recipes: [
      ...
      { id: 91, note: "No cook — just mix dried herbs in a jar. Steep to drink." },
      { id: 92, note: "Buy Mother's Milk tea bags or blend your own. Start day 3-5." },
      { id: 93, note: "Stove 25 min. Freeze in tbsp Souper Cubes. Drop cube in hot water." },
    ],
  },
  {
    id: "soups",
...
const RECIPES = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      "  6 slices bacon, cooked and crumbled (3 per batch) // Reserve the rest for Quiche Lorraine (needs ~18 slices)",
      "  1 cup diced peppers total (1/2 cup per batch) // Reserve 2 bell peppers' worth for Frittata",
      "  1/2 cup cheddar cheese per batch",
      "",
      "BATCH 3-4 FILLING: Spinach Broccoli",
      "  1 cup frozen spinach, thawed and squeezed dry (1/2 cup per batch) // Squeeze in a towel — wet spinach = watery bites",
      "  1 cup small broccoli florets, steamed 2 min (1/2 cup per batch) // Don't use raw — won't cook through",
      "  1/2 cup cheddar cheese per batch",
    ],
    instructions: [
      "Preheat 375F",
  ...
  },
  {
    ...
    ingredients: [
      ...
      "2 tbsp chia seeds",
      "3 tbsp hemp hearts",
      "2 tbsp ground flaxseed // Lactation support + omega-3",
      "1/4 cup pumpkin seeds // Iron + zinc",
      "2 scoops collagen powder // Dissolves completely, adds protein, zero taste",
      "1-2 cups frozen dark cherries // Or mixed berries. Cherry + dark chocolate is unreal.",
    ],
    instructions: [
      "Mix wet: eggs, milk, maple syrup, butter, vanilla, collagen powder",
      "Mix dry: oats, chia seeds, hemp hearts, flax, cinnamon, baking powder, salt",
      "Combine wet and dry",
      "Fold in pumpkin seeds and frozen dark cherries (no need to thaw — they bake through)",
      "Pour into greased 9x13 pan",
      "Bake 350F 30-35 min until golden and set",
      "Cool, cut into bars",
    ],
    yield: "~12 bars per batch. Need 2 batches. Try one cherry-choc batch + one berry batch.",
    freezing: "Wrap individually in parchment. Toaster oven to reheat.",
    note: "SNACK. Loaded with chia, hemp, flax, collagen, and pumpkin seeds. One-handed 3am fuel. Cherry + dark chocolate combo is unreal.",
  },
...
const MEAL_PLAN_DAYS = {"Beef & Sweet Potato Stew": [{day:1,slot:"Lunch",person:"J"},{day:3,slot:"Dinner",person:"K+J"},{day:7,slot:"Lunch",person:"J"},{day:9,slot:"Lunch",person:"K"},{day:22,slot:"Dinner",person:"K+J"},{day:29,slot:"Dinner",person:"K+J"}],"Beef Chili": [{day:3,slot:"Lunch",person:"J"},{day:5,slot:"Dinner",person:"K+J"},{day:14,slot:"Dinner",person:"K+J"},{day:18,slot:"Dinner",person:"K+J"},{day:26,slot:"Lunch",person:"K+J"},{day:35,slot:"Dinner",person:"K+J"},{day:41,slot:"Dinner",person:"K+J"}],"Berry Banana Smoothie": [{day:15,slot:"Breakfast",person:"J"},{day:16,slot:"Breakfast",person:"J"},{day:18,slot:"Breakfast",person:"J"},{day:21,slot:"Breakfast",person:"J"},{day:25,slot:"Breakfast",person:"J"},{day:28,slot:"Breakfast",person:"J"},{day:31,slot:"Breakfast",person:"J"},{day:32,slot:"Breakfast",person:"J"},{day:35,slot:"Breakfast",person:"J"},{day:36,slot:"Breakfast",person:"J"},{day:37,slot:"Breakfast",person:"J"},{day:38,slot:"Breakfast",person:"J"}],"Berry Smoothie": [{day:39,slot:"Breakfast",person:"J"},{day:40,slot:"Breakfast",person:"J"},{day:41,slot:"Breakfast",person:"J"},{day:42,slot:"Breakfast",person:"J"}],"Black Bean Soup": [{day:7,slot:"Lunch",person:"K"},{day:11,slot:"Lunch",person:"K"},{day:12,slot:"Lunch",person:"J"},{day:16,slot:"Dinner",person:"K+J"},{day:22,slot:"Lunch",person:"K+J"},{day:29,slot:"Lunch",person:"K+J"},{day:30,slot:"Lunch",person:"K+J"},{day:38,slot:"Lunch",person:"K+J"},{day:39,slot:"Lunch",person:"K+J"},{day:42,slot:"Lunch",person:"J"}],"Bolognese + Meatballs": [{day:4,slot:"Lunch",person:"J"},{day:7,slot:"Dinner",person:"K+J"},{day:27,slot:"Dinner",person:"K+J"},{day:39,slot:"Dinner",person:"K+J"}],"Butter Chicken + Rice": [{day:9,slot:"Dinner",person:"K+J"},{day:15,slot:"Dinner",person:"K+J"},{day:23,slot:"Dinner",person:"K+J"},{day:32,slot:"Dinner",person:"K+J"},{day:42,slot:"Dinner",person:"K+J"}],"Carrot Ginger Soup": [{day:2,slot:"Dinner",person:"K+J"},{day:6,slot:"Breakfast",person:"K"},{day:14,slot:"Lunch",person:"K+J"},{day:21,slot:"Lunch",person:"K+J"},{day:26,slot:"Breakfast",person:"K"}],"Chicken Ginger Congee": [{day:1,slot:"Dinner",person:"K+J"},{day:2,slot:"Breakfast",person:"K"},{day:7,slot:"Breakfast",person:"K"},{day:8,slot:"Lunch",person:"K+J"},{day:15,slot:"Lunch",person:"K"},{day:23,slot:"Breakfast",person:"K"},{day:24,slot:"Lunch",person:"K"},{day:25,slot:"Breakfast",person:"K"},{day:31,slot:"Lunch",person:"K+J"},{day:36,slot:"Breakfast",person:"K"},{day:39,slot:"Breakfast",person:"K"}],"Chicken Pot Pie": [{day:13,slot:"Dinner",person:"K+J"},{day:27,slot:"Lunch",person:"K+J"},{day:34,slot:"Dinner",person:"K+J"},{day:40,slot:"Lunch",person:"J"}],"Chickpea Curry + Rice": [{day:11,slot:"Dinner",person:"K+J"},{day:19,slot:"Dinner",person:"K+J"},{day:28,slot:"Dinner",person:"K+J"},{day:34,slot:"Lunch",person:"J"},{day:38,slot:"Dinner",person:"K+J"}],"Coconut Mung Bean Dal + Rice": [{day:10,slot:"Dinner",person:"K+J"},{day:17,slot:"Dinner",person:"K+J"},{day:23,slot:"Lunch",person:"J"},{day:30,slot:"Dinner",person:"K+J"},{day:37,slot:"Lunch",person:"K+J"}],"Date & Walnut Congee": [{day:5,slot:"Breakfast",person:"K"},{day:5,slot:"Lunch",person:"J"},{day:16,slot:"Breakfast",person:"K"},{day:18,slot:"Lunch",person:"K+J"},{day:19,slot:"Breakfast",person:"K"},{day:28,slot:"Lunch",person:"K+J"},{day:30,slot:"Breakfast",person:"K"},{day:35,slot:"Breakfast",person:"K"}],"Egg Bites (×3)": [{day:2,slot:"Breakfast",person:"J"},{day:6,slot:"Breakfast",person:"J"},{day:10,slot:"Breakfast",person:"K+J"},{day:11,slot:"Breakfast",person:"J"},{day:14,slot:"Breakfast",person:"J"},{day:17,slot:"Breakfast",person:"J"},{day:20,slot:"Breakfast",person:"J"},{day:24,slot:"Breakfast",person:"K+J"},{day:29,slot:"Breakfast",person:"K"},{day:33,slot:"Breakfast",person:"K"},{day:42,slot:"Breakfast",person:"K"}],"Frittata (×2 slices)": [{day:1,slot:"Breakfast",person:"J"},{day:5,slot:"Breakfast",person:"J"},{day:7,slot:"Breakfast",person:"J"},{day:9,slot:"Breakfast",person:"J"},{day:15,slot:"Breakfast",person:"K"},{day:18,slot:"Breakfast",person:"K"},{day:26,slot:"Breakfast",person:"J"},{day:27,slot:"Breakfast",person:"J"},{day:38,slot:"Breakfast",person:"K"},{day:41,slot:"Breakfast",person:"K"}],"Kabocha & Mung Bean Soup": [{day:4,slot:"Lunch",person:"K"},{day:9,slot:"Breakfast",person:"K"},{day:10,slot:"Lunch",person:"K+J"},{day:16,slot:"Lunch",person:"K+J"},{day:17,slot:"Breakfast",person:"K"},{day:31,slot:"Breakfast",person:"K"},{day:32,slot:"Lunch",person:"K+J"},{day:36,slot:"Lunch",person:"K+J"},{day:42,slot:"Lunch",person:"K"}],"Kitchari": [{day:9,slot:"Lunch",person:"J"},{day:11,slot:"Lunch",person:"J"},{day:12,slot:"Dinner",person:"K+J"},{day:25,slot:"Dinner",person:"K+J"},{day:36,slot:"Dinner",person:"K+J"}],"Minestrone + Meatballs": [{day:13,slot:"Lunch",person:"K+J"},{day:17,slot:"Lunch",person:"J"},{day:20,slot:"Lunch",person:"K+J"},{day:24,slot:"Lunch",person:"J"},{day:25,slot:"Lunch",person:"K+J"},{day:31,slot:"Dinner",person:"K+J"},{day:34,slot:"Lunch",person:"K"}],"Miyeokguk": [{day:1,slot:"Lunch",person:"K"},{day:3,slot:"Lunch",person:"K"},{day:12,slot:"Lunch",person:"K"},{day:17,slot:"Lunch",person:"K"},{day:23,slot:"Lunch",person:"K"},{day:40,slot:"Lunch",person:"K"}],"Moroccan Beef Stew": [{day:8,slot:"Dinner",person:"K+J"},{day:15,slot:"Lunch",person:"J"},{day:21,slot:"Dinner",person:"K+J"},{day:33,slot:"Lunch",person:"K+J"},{day:37,slot:"Dinner",person:"K+J"}],"Oatmeal Bowl + Compote": [{day:14,slot:"Breakfast",person:"K"},{day:19,slot:"Breakfast",person:"J"},{day:21,slot:"Breakfast",person:"K"},{day:23,slot:"Breakfast",person:"J"},{day:27,slot:"Breakfast",person:"K"},{day:29,slot:"Breakfast",person:"J"},{day:30,slot:"Breakfast",person:"J"},{day:32,slot:"Breakfast",person:"K"},{day:33,slot:"Breakfast",person:"J"},{day:34,slot:"Breakfast",person:"J"},{day:37,slot:"Breakfast",person:"K"}],"Quiche (×2 sl.)": [{day:3,slot:"Breakfast",person:"K+J"},{day:4,slot:"Breakfast",person:"K+J"},{day:8,slot:"Breakfast",person:"K+J"},{day:12,slot:"Breakfast",person:"K+J"},{day:13,slot:"Breakfast",person:"J"},{day:22,slot:"Breakfast",person:"K+J"},{day:40,slot:"Breakfast",person:"K"}],"Salmon Patties + Rice": [{day:4,slot:"Dinner",person:"K+J"},{day:20,slot:"Dinner",person:"K+J"},{day:26,slot:"Dinner",person:"K+J"},{day:40,slot:"Dinner",person:"K+J"}],"Sweet Congee (Chai)": [{day:1,slot:"Breakfast",person:"K"},{day:2,slot:"Lunch",person:"K"},{day:5,slot:"Lunch",person:"K"},{day:11,slot:"Breakfast",person:"K"},{day:13,slot:"Breakfast",person:"K"},{day:20,slot:"Breakfast",person:"K"},{day:28,slot:"Breakfast",person:"K"},{day:34,slot:"Breakfast",person:"K"},{day:35,slot:"Lunch",person:"K+J"}],"Sweet Potato Coconut Soup": [{day:6,slot:"Lunch",person:"K+J"},{day:19,slot:"Lunch",person:"K+J"}],"White Chicken Chili": [{day:2,slot:"Lunch",person:"J"},{day:6,slot:"Dinner",person:"K+J"},{day:24,slot:"Dinner",person:"K+J"},{day:33,slot:"Dinner",person:"K+J"},{day:41,slot:"Lunch",person:"K+J"}]};

// Map recipe names to their meal plan lookup keys
// Explicit overrides for names that differ between app and meal plan
const PLAN_KEY_OVERRIDES = {
  "Sweet Potato & Coconut Soup": "Sweet Potato Coconut Soup",
  "Chickpea Coconut Curry": "Chickpea Curry + Rice",
  "Moroccan Beef & Chickpea Stew": "Moroccan Beef Stew",
  "Steel-Cut Oatmeal Bowls": "Oatmeal Bowl + Compote",
};
const RECIPE_TO_PLAN_KEY = {};
RECIPES.forEach((r) => {
  const name = r.name;
  // Check explicit overrides first
  if (PLAN_KEY_OVERRIDES[name]) { RECIPE_TO_PLAN_KEY[r.id] = PLAN_KEY_OVERRIDES[name]; return; }
...
// ── 42-DAY PLAN DATA ──
const PLAN_DATA = {weeks:[{title:"Week 1",dates:"Mar 07 \u2013 Mar 13",notes:["DAYS 1-3: Acute recovery. Massive hormone drop. Iron + protein critical. Warm, easy-to-digest meals. Broth sipping throughout the day.","DAYS 3-5: Baby blues window. Milk coming in. Omega-3s + B vitamins for mood. Caloric needs climbing.","DAYS 5-10: FIRST GROWTH SPURT. Cluster feeding begins. Hunger surges. Calorie-dense meals. Your body suppresses appetite regulation \u2014 eat on demand."],days:[{day:1,dayName:"Saturday",date:"Mar 07",description:"Birth day. Gentle, warming. Miyeokguk is THE Korean recovery soup \u2014 iron-rich seaweed + beef. Sweet congee for Kelly healing breakfast.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Frittata (\u00d72 slices)"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Beef & Sweet Potato Stew"},{slot:"Dinner",kelly:"Chicken Ginger Congee",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:2,dayName:"Sunday",date:"Mar 08",description:"Iron rebuilding. Silkie tonic for blood replenishment. Congee breakfast for postpartum healing.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Sweet Congee (Chai)",jonny:"White Chicken Chili"},{slot:"Dinner",kelly:"Carrot Ginger Soup",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:3,dayName:"Monday",date:"Mar 09",description:"Day 3: Hormone crash. Milk transitioning. Beef stew for iron. Don\u2019t hold back on hearty food if craving it.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"(same)"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Beef Chili"},{slot:"Dinner",kelly:"Beef & Sweet Potato Stew",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:4,dayName:"Tuesday",date:"Mar 10",description:"Day 4: Baby blues peak. Salmon for omega-3s \u2014 directly supports mood. B vitamins from egg-based breakfast.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"(same)"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"Bolognese + Meatballs"},{slot:"Dinner",kelly:"Salmon Patties + Rice",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:5,dayName:"Wednesday",date:"Mar 11",description:"Day 5: Milk fully in. Engorgement. Caloric needs climbing. Chili brings iron + protein + calories.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Date & Walnut Congee",jonny:"Frittata (\u00d72 slices)"},{slot:"Lunch",kelly:"Sweet Congee (Chai)",jonny:"Date & Walnut Congee"},{slot:"Dinner",kelly:"Beef Chili",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:6,dayName:"Thursday",date:"Mar 12",description:"Building toward growth spurt. Calorie-dense dinner. Carrot ginger soup as breakfast.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Carrot Ginger Soup",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Sweet Potato Coconut Soup",jonny:"(same)"},{slot:"Dinner",kelly:"White Chicken Chili",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:7,dayName:"Friday",date:"Mar 13",description:"DAY 7: Growth spurt likely starting. Cluster feeding. Hunger surges. Bolognese + meatballs for calorie density.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Frittata (\u00d72 slices)"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"Beef & Sweet Potato Stew"},{slot:"Dinner",kelly:"Bolognese + Meatballs",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]}]},{title:"Week 2",dates:"Mar 14 \u2013 Mar 20",notes:["DAYS 5-10: FIRST GROWTH SPURT continues.","WEEKS 2-3: Second growth spurt. Sustained elevated appetite. Cumulative sleep deprivation peaks. Nutrient density critical."],days:[{day:8,dayName:"Saturday",date:"Mar 14",description:"Growth spurt day 2. Cluster feeding. Eat on demand \u2014 your body needs it.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"(same)"},{slot:"Lunch",kelly:"Chicken Ginger Congee",jonny:"(same)"},{slot:"Dinner",kelly:"Moroccan Beef Stew",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:9,dayName:"Sunday",date:"Mar 15",description:"Growth spurt peak. Butter chicken = protein + healthy fat. Extra snacks encouraged.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Kabocha & Mung Bean Soup",jonny:"Frittata (\u00d72 slices)"},{slot:"Lunch",kelly:"Beef & Sweet Potato Stew",jonny:"Kitchari"},{slot:"Dinner",kelly:"Butter Chicken + Rice",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:10,dayName:"Monday",date:"Mar 16",description:"Growth spurt easing. Dal is warming, easy to digest, protein-rich.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"(same)"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Coconut Mung Bean Dal + Rice",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:11,dayName:"Tuesday",date:"Mar 17",description:"Between growth spurts. Building reserves. Sweet congee for Kelly, kitchari for Jonny (uses surplus).",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"Kitchari"},{slot:"Dinner",kelly:"Chickpea Curry + Rice",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:12,dayName:"Wednesday",date:"Mar 18",description:"Kitchari = Ayurvedic reset. Gentle on digestion, deeply nourishing.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"(same)"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Black Bean Soup"},{slot:"Dinner",kelly:"Kitchari",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]},{day:13,dayName:"Thursday",date:"Mar 19",description:"Comfort food night. Pot pie = warm hug in a bowl.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Quiche (\u00d72 sl.)"},{slot:"Lunch",kelly:"Minestrone + Meatballs",jonny:"(same)"},{slot:"Dinner",kelly:"Chicken Pot Pie",jonny:"(same)"},{slot:"PM Sip",kelly:"Golden Broth",jonny:"\u2014"}]},{day:14,dayName:"Friday",date:"Mar 20",description:"Loading iron before week 2-3 growth spurt. Last day of silkie tonic daily schedule.",meals:[{slot:"AM Broth",kelly:"Silkie Chicken Tonic",jonny:"\u2014"},{slot:"Breakfast",kelly:"Oatmeal Bowl + Compote",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Carrot Ginger Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Beef Chili",jonny:"(same)"},{slot:"PM Sip",kelly:"Jujube Goji Ginger Tea",jonny:"\u2014"}]}]},{title:"Week 3",dates:"Mar 21 \u2013 Mar 27",notes:["WEEKS 2-3: Second growth spurt. Sustained elevated appetite. Sleep deprivation peaks.","WEEK 3-4: THE CRISIS WINDOW. Highest PPD/PPA risk. Iron, protein, B vitamins, choline all mood-supporting."],days:[{day:15,dayName:"Saturday",date:"Mar 21",description:"Week 3 growth spurt window. Calorie-dense dinner. Nutrient density matters. Smoothie for Jonny \u2014 using up frozen berries.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Frittata (\u00d72 slices)",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Chicken Ginger Congee",jonny:"Moroccan Beef Stew"},{slot:"Dinner",kelly:"Butter Chicken + Rice",jonny:"(same)"}]},{day:16,dayName:"Sunday",date:"Mar 22",description:"Black bean soup \u2014 protein, fiber, iron. Easy on digestion.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Date & Walnut Congee",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Black Bean Soup",jonny:"(same)"}]},{day:17,dayName:"Monday",date:"Mar 23",description:"Miyeokguk for Kelly\u2019s iron. Dal for dinner \u2014 warming and protein-rich.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Kabocha & Mung Bean Soup",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Minestrone + Meatballs"},{slot:"Dinner",kelly:"Coconut Mung Bean Dal + Rice",jonny:"(same)"}]},{day:18,dayName:"Tuesday",date:"Mar 24",description:"Iron + protein focus. Hidden liver in the chili = stealth nutrition.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Frittata (\u00d72 slices)",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Date & Walnut Congee",jonny:"(same)"},{slot:"Dinner",kelly:"Beef Chili",jonny:"(same)"}]},{day:19,dayName:"Wednesday",date:"Mar 25",description:"Chickpea curry \u2014 plant protein + iron. Good variety from beef-heavy earlier days.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Date & Walnut Congee",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Sweet Potato Coconut Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Chickpea Curry + Rice",jonny:"(same)"}]},{day:20,dayName:"Thursday",date:"Mar 26",description:"Salmon = omega-3 for mood support. Week 3 is highest PPD risk window.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Egg Bites (\u00d73)"},{slot:"Lunch",kelly:"Minestrone + Meatballs",jonny:"(same)"},{slot:"Dinner",kelly:"Salmon Patties + Rice",jonny:"(same)"}]},{day:21,dayName:"Friday",date:"Mar 27",description:"Heading into week 3-4 crisis. Moroccan stew is iron + protein dense.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Oatmeal Bowl + Compote",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Carrot Ginger Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Moroccan Beef Stew",jonny:"(same)"}]}]},{title:"Week 4",dates:"Mar 28 \u2013 Apr 03",notes:["WEEK 3-4: THE CRISIS WINDOW. Highest PPD/PPA risk. Growth spurt + sleep debt + hormonal low. Iron, protein, B vitamins, choline all mood-supporting."],days:[{day:22,dayName:"Saturday",date:"Mar 28",description:"Crisis window. Beef stew = iron + B12 + comfort. Choline-rich breakfast.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"(same)"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Beef & Sweet Potato Stew",jonny:"(same)"}]},{day:23,dayName:"Sunday",date:"Mar 29",description:"Iron-rich lunch for Kelly. Butter chicken for protein-dense dinner.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Coconut Mung Bean Dal + Rice"},{slot:"Dinner",kelly:"Butter Chicken + Rice",jonny:"(same)"}]},{day:24,dayName:"Monday",date:"Mar 30",description:"Eggs for choline. White chili for protein.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"(same)"},{slot:"Lunch",kelly:"Chicken Ginger Congee",jonny:"Minestrone + Meatballs"},{slot:"Dinner",kelly:"White Chicken Chili",jonny:"(same)"}]},{day:25,dayName:"Tuesday",date:"Mar 31",description:"Kitchari for digestive reset amid the intensity.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Minestrone + Meatballs",jonny:"(same)"},{slot:"Dinner",kelly:"Kitchari",jonny:"(same)"}]},{day:26,dayName:"Wednesday",date:"Apr 01",description:"Salmon again \u2014 omega-3 is your best nutritional ally for mood right now.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Carrot Ginger Soup",jonny:"Frittata (\u00d72 slices)"},{slot:"Lunch",kelly:"Beef Chili",jonny:"(same)"},{slot:"Dinner",kelly:"Salmon Patties + Rice",jonny:"(same)"}]},{day:27,dayName:"Thursday",date:"Apr 02",description:"Hidden liver in bolognese = stealth iron + B12. The body doesn\u2019t know, but it benefits.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Oatmeal Bowl + Compote",jonny:"Frittata (\u00d72 slices)"},{slot:"Lunch",kelly:"Chicken Pot Pie",jonny:"(same)"},{slot:"Dinner",kelly:"Bolognese + Meatballs",jonny:"(same)"}]},{day:28,dayName:"Friday",date:"Apr 03",description:"Closing the crisis window. Hormones beginning to rise. You\u2019re through the hardest part.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Date & Walnut Congee",jonny:"(same)"},{slot:"Dinner",kelly:"Chickpea Curry + Rice",jonny:"(same)"}]}]},{title:"Week 5",dates:"Apr 04 \u2013 Apr 10",notes:["WEEKS 5-6: Stabilization. Hormones rising. Feeding patterns more predictable. Full variety. Still +400 cal/day for breastfeeding."],days:[{day:29,dayName:"Saturday",date:"Apr 04",description:"Stabilization phase. Appetite still elevated but less desperate.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Beef & Sweet Potato Stew",jonny:"(same)"}]},{day:30,dayName:"Sunday",date:"Apr 05",description:"Stabilization. Congee + black bean for Kelly surpluses.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Date & Walnut Congee",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Coconut Mung Bean Dal + Rice",jonny:"(same)"}]},{day:31,dayName:"Monday",date:"Apr 06",description:"Stabilization. Kabocha soup breakfast for Kelly.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Kabocha & Mung Bean Soup",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Chicken Ginger Congee",jonny:"(same)"},{slot:"Dinner",kelly:"Minestrone + Meatballs",jonny:"(same)"}]},{day:32,dayName:"Tuesday",date:"Apr 07",description:"Oatmeal breakfast for Kelly.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Oatmeal Bowl + Compote",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Butter Chicken + Rice",jonny:"(same)"}]},{day:33,dayName:"Wednesday",date:"Apr 08",description:"Stabilization phase.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Moroccan Beef Stew",jonny:"(same)"},{slot:"Dinner",kelly:"White Chicken Chili",jonny:"(same)"}]},{day:34,dayName:"Thursday",date:"Apr 09",description:"Sweet congee + minestrone for Kelly, chickpea curry for Jonny surplus.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Sweet Congee (Chai)",jonny:"Oatmeal Bowl + Compote"},{slot:"Lunch",kelly:"Minestrone + Meatballs",jonny:"Chickpea Curry + Rice"},{slot:"Dinner",kelly:"Chicken Pot Pie",jonny:"(same)"}]},{day:35,dayName:"Friday",date:"Apr 10",description:"Date congee + sweet congee for Kelly.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Date & Walnut Congee",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Sweet Congee (Chai)",jonny:"(same)"},{slot:"Dinner",kelly:"Beef Chili",jonny:"(same)"}]}]},{title:"Week 6",dates:"Apr 11 \u2013 Apr 17",notes:["WEEKS 5-6: Stabilization. Hormones rising. Feeding patterns more predictable. Full variety. Still +400 cal/day for breastfeeding."],days:[{day:36,dayName:"Saturday",date:"Apr 11",description:"Week 6 growth spurt possible around now.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Kitchari",jonny:"(same)"}]},{day:37,dayName:"Sunday",date:"Apr 12",description:"Oatmeal breakfast for Kelly.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Oatmeal Bowl + Compote",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Coconut Mung Bean Dal + Rice",jonny:"(same)"},{slot:"Dinner",kelly:"Moroccan Beef Stew",jonny:"(same)"}]},{day:38,dayName:"Monday",date:"Apr 13",description:"Stabilization phase.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Frittata (\u00d72 slices)",jonny:"Berry Banana Smoothie"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Chickpea Curry + Rice",jonny:"(same)"}]},{day:39,dayName:"Tuesday",date:"Apr 14",description:"Congee + black bean for Kelly.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Chicken Ginger Congee",jonny:"Berry Smoothie"},{slot:"Lunch",kelly:"Black Bean Soup",jonny:"(same)"},{slot:"Dinner",kelly:"Bolognese + Meatballs",jonny:"(same)"}]},{day:40,dayName:"Wednesday",date:"Apr 15",description:"Quiche breakfast for Kelly.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Quiche (\u00d72 sl.)",jonny:"Berry Smoothie"},{slot:"Lunch",kelly:"Miyeokguk",jonny:"Chicken Pot Pie"},{slot:"Dinner",kelly:"Salmon Patties + Rice",jonny:"(same)"}]},{day:41,dayName:"Thursday",date:"Apr 16",description:"Frittata breakfast for Kelly.",meals:[{slot:"AM Broth",kelly:"Beef Bone Broth (2-cup)",jonny:"\u2014"},{slot:"Breakfast",kelly:"Frittata (\u00d72 slices)",jonny:"Berry Smoothie"},{slot:"Lunch",kelly:"White Chicken Chili",jonny:"(same)"},{slot:"Dinner",kelly:"Beef Chili",jonny:"(same)"}]},{day:42,dayName:"Friday",date:"Apr 17",description:"Day 42. Six weeks postpartum. You made it.",meals:[{slot:"AM Broth",kelly:"Chicken Bone Broth",jonny:"\u2014"},{slot:"Breakfast",kelly:"Egg Bites (\u00d73)",jonny:"Berry Smoothie"},{slot:"Lunch",kelly:"Kabocha & Mung Bean Soup",jonny:"Black Bean Soup"},{slot:"Dinner",kelly:"Butter Chicken + Rice",jonny:"(same)"}]}]}]};
      ...
      {currentTab === "42-Day Plan" && (
        <div className="space-y-6">
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-4">
            <h2 className="text-xl font-bold text-gray-900 mb-1">42-Day Postpartum Meal Plan</h2>
            <p className="text-sm text-gray-500">Kelly &amp; Jonny Miller &mdash; Starting March 7, 2026</p>
            <div className="mt-3 flex gap-3 text-xs">
              <span className="flex items-center gap-1"><span className="w-2.5 h-2.5 rounded-full bg-pink-400" />Kelly only</span>
              <span className="flex items-center gap-1"><span className="w-2.5 h-2.5 rounded-full bg-blue-400" />Jonny only</span>
              <span className="flex items-center gap-1"><span className="w-2.5 h-2.5 rounded-full bg-amber-400" />Both</span>
              <span className="flex items-center gap-1"><span className="w-2.5 h-2.5 rounded-full bg-gray-300" />Broth/Sip</span>
            </div>
          </div>
          ...
          {PLAN_DATA.weeks.map((week) => (
            <div key={week.title} className="space-y-3">
              <div className="sticky top-0 z-10 bg-gradient-to-r from-amber-50 to-rose-50 rounded-lg px-4 py-3 border border-amber-200 shadow-sm">
                <h3 className="font-bold text-amber-900">{week.title} <span className="font-normal text-amber-700 text-sm ml-2">{week.dates}</span></h3>
                {week.notes.map((note, i) => (
                  <p key={i} className="text-xs text-amber-800 mt-1 leading-relaxed">{note}</p>
                ))}
              </div>
                  ...
                  <div className="px-4 py-3 bg-gray-50 border-b border-gray-100">
                    <div className="flex items-baseline justify-between">
                      <h4 className="font-bold text-gray-900">
                        <span className="text-amber-700">Day {day.day}</span>
                        <span className="text-gray-400 mx-2">&middot;</span>
                        {day.dayName}, {day.date}
                      </h4>
                    </div>
                    <p className="text-sm text-gray-600 mt-1 italic leading-relaxed">{day.description}</p>
                  </div>

                  <div className="divide-y divide-gray-50">
                    {day.meals.filter(m => m.slot !== "AM Broth" && m.slot !== "PM Sip").map((meal) => {
                      const isSame = meal.jonny === "(same)";
                      const isKellyOnly = meal.jonny === "\u2014" || meal.jonny === "—";
                      return (
                        <div key={meal.slot} className="px-4 py-2 flex items-start gap-3">
                          <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider w-16 pt-0.5 shrink-0">{meal.slot === "Breakfast" ? "Bkfst" : meal.slot}</span>
                          {isSame ? (
                            <div className="flex items-center gap-2">
                              <span className="w-2 h-2 rounded-full bg-amber-400 shrink-0 mt-1" />
                              <span className="text-sm text-gray-800">{meal.kelly}</span>
                            </div>
                          ) : isKellyOnly ? (
                            <div className="flex items-center gap-2">
                              <span className="w-2 h-2 rounded-full bg-pink-400 shrink-0 mt-1" />
                              <span className="text-sm text-gray-800">{meal.kelly}</span>
                            </div>
                          ) : (
                            <div className="flex flex-col sm:flex-row sm:gap-4 gap-1 flex-1">
                              <div className="flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-pink-400 shrink-0 mt-0.5" />
                                <span className="text-sm text-gray-800">{meal.kelly}</span>
                              </div>
                              <div className="flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-blue-400 shrink-0 mt-0.5" />
                                <span className="text-sm text-gray-600">{meal.jonny}</span>
                              </div>
                            </div>
                          )}
                        </div>
                    ...
                    {/* Broth/sip line */}
                    {(() => {
                      const broth = day.meals.find(m => m.slot === "AM Broth");
                      const sip = day.meals.find(m => m.slot === "PM Sip");
                      if (!broth && !sip) return null;
                      return (
                        <div className="px-4 py-1.5 bg-gray-50/50 flex items-center gap-3 text-xs text-gray-400">
                          <span className="w-2 h-2 rounded-full bg-gray-300 shrink-0" />
                          {broth && <span>AM: {broth.kelly}</span>}
                          {broth && sip && <span>&middot;</span>}
                          {sip && <span>PM: {sip.kelly}</span>}
                        </div>
                      );
                    })()}
                  </div>
