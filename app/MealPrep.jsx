...
const MEAL_PLAN_DAYS = {"Beef & Sweet Potato Stew": [{day:1,slot:"Lunch",person:"J"},{day:3,slot:"Dinner",person:"K+J"},{day:7,slot:"Lunch",person:"J"},{day:9,slot:"Lunch",person:"K"},{day:20,slot:"Lunch",person:"K+J"},{day:22,slot:"Dinner",person:"K+J"}],"Beef Chili": [{day:3,slot:"Lunch",person:"J"},{day:5,slot:"Dinner",person:"K+J"},{day:13,slot:"Lunch",person:"K+J"},{day:14,slot:"Dinner",person:"K+J"},{day:18,slot:"Dinner",person:"K+J"},{day:26,slot:"Lunch",person:"K+J"}],"Berry Banana Smoothie": [{day:15,slot:"Breakfast",person:"J"},{day:16,slot:"Breakfast",person:"J"},{day:18,slot:"Breakfast",person:"J"},{day:21,slot:"Breakfast",person:"J"},{day:25,slot:"Breakfast",person:"J"},{day:28,slot:"Breakfast",person:"J"}],"Black Bean Soup": [{day:7,slot:"Lunch",person:"K"},{day:11,slot:"Lunch",person:"K"},{day:12,slot:"Lunch",person:"J"},{day:16,slot:"Dinner",person:"K+J"},{day:22,slot:"Lunch",person:"K+J"}],"Bolognese + Meatballs": [{day:4,slot:"Lunch",person:"J"},{day:7,slot:"Dinner",person:"K+J"},{day:17,slot:"Lunch",person:"J"},{day:27,slot:"Dinner",person:"K+J"}],"Butter Chicken + Rice": [{day:9,slot:"Dinner",person:"K+J"},{day:15,slot:"Dinner",person:"K+J"},{day:23,slot:"Dinner",person:"K+J"}],"Carrot Ginger Soup": [{day:2,slot:"Dinner",person:"K+J"},{day:5,slot:"Lunch",person:"K"},{day:14,slot:"Lunch",person:"K+J"},{day:18,slot:"Lunch",person:"J"},{day:21,slot:"Lunch",person:"K+J"},{day:26,slot:"Breakfast",person:"K"},{day:30,slot:"Lunch",person:"K+J"}],"Chicken Ginger Congee": [{day:1,slot:"Dinner",person:"K+J"},{day:2,slot:"Breakfast",person:"K"},{day:7,slot:"Breakfast",person:"K"},{day:8,slot:"Lunch",person:"J"},{day:15,slot:"Lunch",person:"K"},{day:23,slot:"Breakfast",person:"K"},{day:24,slot:"Lunch",person:"K"},{day:25,slot:"Breakfast",person:"K"}],"Chickpea Curry + Rice": [{day:11,slot:"Dinner",person:"K+J"},{day:19,slot:"Dinner",person:"K+J"},{day:28,slot:"Dinner",person:"K+J"}],"Coconut Mung Bean Dal + Rice": [{day:10,slot:"Dinner",person:"K+J"},{day:17,slot:"Dinner",person:"K+J"},{day:23,slot:"Lunch",person:"J"}],"Miyeokguk": [{day:1,slot:"Lunch",person:"K"},{day:3,slot:"Lunch",person:"K"},{day:4,slot:"Lunch",person:"K"},{day:8,slot:"Lunch",person:"K"}]};
...
const MEAL_PAIRINGS = {
  ...
  "Coconut Mung Bean Dal + Rice": "Pack with: ½ cup mango rice (natural flavor match) or plain rice. Dal is a sauce — needs the carb.",
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2.5 text-sm text-gray-700">
                  <div className="bg-orange-50/40 rounded-lg p-3 border border-orange-100/60"><strong className="text-gray-900">Soups:</strong> Black Bean, Carrot Ginger, Sweet Potato Coconut, Kabocha &amp; Mung Bean</div>
                  ...
                  <div className="bg-orange-50/40 rounded-lg p-3 border border-orange-100/60"><strong className="text-gray-900">Comfort:</strong> White Chicken Chili, Bolognese + Meatballs</div>
