...
const P = [
  { id:1, t:"Broths + Congees + Gentle Soups + Ferments", w:"Week 1 Feb", pm:"Week 1 postpartum", c:"amber",
    days:[
      { d:1, t:"Day 1 (~4 hrs)", s:[
        { l:"Morning", t:["Preheat oven 425°F","Roast 3 whole chickens (~1.5 hrs until 165°F)","Prep vegetables for broths"] },
        { l:"Midday", t:["Remove chickens, rest 15 min, shred meat","Break down carcasses + chicken feet → stockpot","Start chicken broth (12-24 hrs stove / 2-3 hrs IP)","Roast beef bones 425°F 30-40 min","Start beef broth in 2nd pot or IP"] },
        { l:"Afternoon", t:["Make sauerkraut (salt, massage, pack jars)","Make kimchi (salt cabbage, make paste, pack jars)","Store ferments in cool dark place"] },
        { l:"Evening", t:["Strain chicken broth, cool","Make golden broth (turmeric, ginger, ghee)","Portion into Souper Cubes, freeze overnight"] }
      ]},
      { d:2, t:"Day 2 (~4-5 hrs)", s:[
        { l:"Morning", t:["Pop frozen cubes → labeled bags, reload trays","Make chicken ginger congee (simmer 1.5-2 hrs)","Roast kabocha squash (cut-side down 45 min)"] },
        { l:"Midday", t:["Make carrot ginger soup (sauté, simmer, blend)","Make kabocha & red lentil soup","Strain beef broth, cool"] },
        { l:"Afternoon", t:["Cool soups to room temp","Portion congee into Souper Cubes (leave room)","Portion soups + beef broth into Souper Cubes","Freeze overnight"] },
        { l:"Evening", t:["Pop all frozen cubes → labeled bags","Organize freezer","Clean kitchen"] }
      ]}
    ], y:"~50+ two-cup portions + 4 qts ferments"
  },
  { id:2, t:"Stews + Curries + Heartier Soups", w:"Week 2 Feb", pm:"Week 2-3 postpartum", c:"orange",
    days:[
      { d:1, t:"Day 1 — Slow Braises", s:[
        { l:"Morning", t:["Brown oxtail, start oxtail stew (3+ hrs)","Brown lamb, start lamb & white bean stew","Soak dried beans if needed"] },
        { l:"Midday", t:["Start beef bourguignon (brown, deglaze, build sauce)","Make black bean soup"] },
        { l:"Evening", t:["Cool all stews to room temp","Portion into Souper Cubes, freeze overnight"] }
      ]},
      { d:2, t:"Day 2 — Curries & Soups", s:[
        { l:"Morning", t:["Pop cubes → bags, reload trays","Make Thai massaman curry","Make butter chicken"] },
        { l:"Midday", t:["Make lamb tagine","Make minestrone base","Make Italian wedding soup"] },
        { l:"Evening", t:["Cool everything, portion, freeze","Label all bags, organize freezer"] }
      ]}
    ], y:"~40+ portions"
  },
  { id:3, t:"Proteins + Pastas + Iron-Rich", w:"Week 3 Feb", pm:"Week 3-4 postpartum", c:"red",
    days:[
      { d:1, t:"Day 1 — Meatballs & Proteins", s:[
        { l:"Morning", t:["Prep chicken livers (soak in milk, blend smooth)","Make meatball mix (beef/pork/hidden liver), form & bake","Start bolognese with hidden liver (long simmer)"] },
        { l:"Midday", t:["Start carnitas (season pork, braise 3-4 hrs)","Make beef chili with hidden liver"] },
        { l:"Evening", t:["Shred carnitas","Cool everything, portion, freeze"] }
      ]},
      { d:2, t:"Day 2 — Short Ribs & Sauces", s:[
        { l:"Morning", t:["Pop cubes → bags, reload trays","Braise short ribs (sear, braise 3+ hrs)","Large batch shredded chicken (poach/roast thighs)"] },
        { l:"Midday", t:["Make creamy tomato sausage sauce","Make mac and cheese (undercook pasta)"] },
        { l:"Evening", t:["Cool and portion everything","Freeze, label, organize"] }
      ]}
    ], y:"~50+ portions"
  },
  { id:4, t:"Lighter Items + Breakfast + Patties + Bases", w:"Week 4 Feb", pm:"Week 5-6 postpartum", c:"green",
    days:[
      { d:1, t:"Day 1 — Patties & Dals", s:[
        { l:"Morning", t:["Make salmon patties","Make black bean patties","Make white bean & herb patties","Make chicken-veggie patties"] },
        { l:"Midday", t:["Make egg bites (muffin tins, bake)","Make mini frittatas","Make coconut lentil dal"] },
        { l:"Evening", t:["Make tadka dal","Make chana masala","Cool, portion, freeze"] }
      ]},
      { d:2, t:"Day 2 — Breakfast & Bases", s:[
        { l:"Morning", t:["Pop cubes → bags, reload trays","Assemble breakfast burritos (wrap in foil)","Make savory muffins + oatmeal cups"] },
        { l:"Midday", t:["Cook rice in broth (big batch)","Mashed potatoes + sweet potatoes","Make polenta","Cook black beans + white beans"] },
        { l:"Evening", t:["Make chicken pot pie filling","Assemble shepherd's pie","Make sauces: pesto, marinara, chimichurri, ginger-scallion oil","Portion everything, freeze, label","Final freezer organization — you're done!"] }
      ]}
    ], y:"~60+ portions"
  }
];
...
const SH = {
  ...
  equip:["Souper Cubes 2-cup ×4 (~$80)","Souper Cubes 1-cup ×2 (~$34)","Souper Cubes ½-cup ×1 (~$15)","Souper Cubes 2-TB ×1 (~$15)","Gallon freezer bags 2-3 boxes","Quart freezer bags 2-3 boxes"],
  asian:[
    {c:"Proteins",i:["Chicken feet — 3 lbs","Silkie chicken (black) — 2 whole"]},
    {c:"Produce",i:["Fresh turmeric — 4 oz","Napa cabbage — 2 heads (kimchi)","Green onions — 2 bunches (kimchi)","Fresh ginger — 1 large hand"]},
    {c:"Dried Goods",i:["Goji berries — 8 oz","Red dates (jujubes) — 12 oz","Gochugaru — 1 lb","Dried shiitake — 8 oz","Kombu — 4 oz","Dried longan — 8 oz","Black sesame seeds — 8 oz"]},
    {c:"Pantry",i:["Toasted sesame oil","White pepper (ground)","Miso paste","Fish sauce (Red Boat)","Coconut aminos"]}
  ],
  butcher:[
    {c:"Phase 1",i:["Whole chickens ×3 (pasture-raised)","Chicken thighs bone-in — 4 lbs","Beef marrow bones — 3-4 lbs (cut crosswise)","Oxtail — 2-3 lbs"]},
...
const R = [
  {id:1,n:"Chicken Bone Broth",cat:"Foundations",ph:1,tg:["collagen","base"],
    ing:["3 chicken carcasses","1 lb chicken feet","2 onions quartered","4 carrots chopped","4 celery stalks","1 head garlic halved","2 tbsp ACV","1 tbsp peppercorns","Thyme, parsley, bay leaves","~6 qts cold water"],
    ins:["Add carcasses + feet to stockpot","Cover with cold water, add vinegar","Bring to boil, skim foam","Add vegetables and aromatics","Low simmer 12-24 hrs","Strain through fine mesh","Cool, skim fat if desired"],
    ip:"IP: max line, HIGH 2-3 hrs, natural release",yi:"~20-24 cups",fr:"Freeze 2-cup + 1-cup portions. Should jiggle when cold."},
  {id:2,n:"Beef Bone Broth",cat:"Foundations",ph:1,tg:["collagen","iron"],
    ing:["3-4 lbs beef marrow bones","2-3 lbs oxtail (opt)","2 onions","4 carrots","4 celery","1 head garlic","2 tbsp tomato paste","2 tbsp ACV","Peppercorns, thyme, bay"],
    ins:["CRITICAL: Roast bones 425°F 30-40 min","Transfer to pot","Deglaze roasting pan, add to pot","Add veggies, aromatics, vinegar, paste","Cover with cold water, boil, skim","Low simmer 24-36 hrs"],
    ip:"IP: HIGH 3 hrs, natural release",yi:"~12-16 cups",fr:"Freeze 2-cup + 1-cup portions"},
  {id:3,n:"Golden Broth",cat:"Foundations",ph:1,tg:["warming","tonic"],
    ing:["8 cups chicken broth","3\" fresh turmeric (or 1 tbsp ground)","2\" fresh ginger","2 tbsp ghee","½ tsp black pepper","Salt"],
    ins:["Combine broth, turmeric, ginger","Gentle simmer 15-20 min","Stir in ghee + black pepper","Strain, season"],
    yi:"~8 cups",fr:"Freeze 2-cup portions. Sip warm as healing tonic."},
  {id:4,n:"Marinara Sauce",cat:"Foundations",ph:4,tg:["base"],
    ing:["2 (28oz) cans San Marzano tomatoes","1 onion diced","6 cloves garlic","¼ cup olive oil","2 tbsp tomato paste","Oregano, basil, red pepper flakes, salt"],
    ins:["Sauté onion in oil 7-8 min","Add garlic 1 min, tomato paste 2 min","Add tomatoes, herbs","Simmer 30-45 min"],
    yi:"~8 cups",fr:"Freeze ½-cup and 1-cup portions"},
  {id:5,n:"Pesto",cat:"Foundations",ph:4,tg:["base"],
    ing:["4 cups basil packed","½ cup pine nuts toasted","4 cloves garlic","1 cup Parmesan","¾ cup olive oil","Lemon, salt, pepper"],
  ...
  {id:7,n:"Chimichurri",cat:"Foundations",ph:4,tg:["fresh"],
    ing:["2 cups parsley chopped","½ cup oregano","6 cloves garlic","1 shallot diced","¾ cup olive oil","¼ cup red wine vinegar","Red pepper flakes, salt"],
  ...
  {id:8,n:"Chicken Ginger Congee",cat:"Soups",ph:1,tg:["gentle","week1"],
    ing:["2 cups jasmine rice","12 cups chicken broth","4 cups water","3\" ginger sliced","2-3 cups shredded chicken","2 tbsp sesame oil","Salt"],
    ins:["Rinse rice until clear","Combine rice, broth, water, ginger","Boil → low simmer 1.5-2 hrs, stir occasionally","Stir in chicken + sesame oil","Season"],
    ip:"IP: 30 min, natural release 15 min",yi:"~12 two-cup portions",fr:"Thickens when frozen. Add broth when reheating.",
    top:"Green onions, sesame seeds, coconut aminos, soft-boiled egg"},
  {id:9,n:"Carrot Ginger Soup",cat:"Soups",ph:1,tg:["gentle","week1"],
    ing:["2 lbs carrots","1 onion","4 cloves garlic","3\" ginger","6 cups broth","1 can coconut milk","2 tbsp ghee","1 tsp cumin"],
    ins:["Sauté onion in ghee 5-7 min","Add garlic, ginger 1 min","Add carrots, cumin, broth","Simmer 25-30 min","Blend smooth, stir in coconut milk"],
    yi:"~10 two-cup portions",fr:"Freezes beautifully"},
  {id:10,n:"Italian Wedding Soup",cat:"Soups",ph:2,tg:["hearty"],
    ing:["Meatballs","8 cups chicken broth","2 cups escarole/spinach","1 cup small pasta","2 eggs","½ cup Parmesan"],
  ...
  {id:11,n:"Kabocha & Red Lentil Soup",cat:"Soups",ph:1,tg:["gentle","week1"],
    ...
    ins:["Roast squash cut-side down 400°F 45 min","Scoop flesh","Sauté onion, add garlic/ginger/spices","Add squash, lentils, broth","Simmer 20-25 min","Blend, stir in coconut milk"],
  ...
  {id:12,n:"Black Bean Soup",cat:"Soups",ph:2,tg:["hearty","fiber"],
    ...
    ins:["Sauté onion, garlic, spices","Add beans + broth","Simmer 1.5-2 hrs until tender","Blend half for creaminess","Add lime juice, season"],
  ...
  {id:13,n:"Chicken Noodle Soup",cat:"Soups",ph:2,tg:["classic"],
    ...
    ins:["Sauté veggies in butter 5-7 min","Add broth, herbs, simmer 15 min","Add chicken, season"],
  ...
  {id:14,n:"Minestrone",cat:"Soups",ph:2,tg:["hearty"],
    ...
    ins:["Sauté veggies 5 min","Add garlic, herbs 2 min","Add tomatoes, broth, beans","Simmer 20-30 min"],
  ...
  {id:15,n:"Oxtail Stew",cat:"Stews",ph:2,tg:["collagen","iron"],
    ...
    ins:["Season + flour oxtail, brown deeply","Sauté veggies","Add garlic, tomato paste 2 min","Deglaze with wine","Return oxtail, add broth + herbs","Cover, low simmer 3-4 hours until falling off bone"],
  ...
  {id:16,n:"Lamb & White Bean Stew",cat:"Stews",ph:2,tg:["hearty"],
    ...
    ins:["Brown lamb in batches","Sauté veggies, add spices","Add tomatoes, broth, return lamb","Simmer 2-2.5 hrs","Add beans last 30 min"],
  ...
  {id:17,n:"Beef Chili (Hidden Liver)",cat:"Stews",ph:3,tg:["iron","hidden liver"],
    ...
    ins:["Brown beef, add blended livers (they disappear)","Sauté onions, garlic","Add spices, tomato paste 2 min","Add tomatoes, broth, beans","Simmer 45 min-1 hr"],
  ...
  {id:19,n:"Butter Chicken",cat:"Stews",ph:2,tg:["comfort"],
    ...
    ins:["Marinate chicken in yogurt 30 min+","Sauté onion golden, add garlic/ginger/spices","Add tomatoes, simmer 15 min, blend smooth","Add chicken, cook 15-20 min","Stir in cream, pinch of sugar"],
  ...
  {id:20,n:"Beef Bourguignon",cat:"Stews",ph:2,tg:["iron","slow-cook"],
    ...
    ins:["Cook bacon crispy, remove","Brown floured beef in bacon fat","Sauté veggies","Add paste 2 min, deglaze with wine","Add broth, herbs, return beef + bacon","Cover, simmer 2.5-3 hrs until fork-tender"],
  ...
  {id:21,n:"Lamb Tagine",cat:"Stews",ph:2,tg:["warming"],
    ...
    ins:["Brown lamb in batches","Sauté onion, garlic, add spices","Add tomatoes, broth, return lamb","Simmer 1.5-2 hrs","Add apricots, olives, honey last 30 min"],
    yi:"~8-10 portions",fr:"Serve over couscous or rice"},
  {id:22,n:"Bolognese (Hidden Liver)",cat:"Pastas",ph:3,tg:["iron","hidden liver"],
    ing:["1 lb ground beef","½ lb ground pork","4 oz chicken livers (blended)","Onion, 2 carrots, 2 celery (soffritto)","4 garlic","1 cup red wine","28oz crushed tomatoes","1 cup milk","Tomato paste, thyme, bay"],
    ins:["Sauté soffritto 10 min","Add garlic, then meats + blended livers, brown","Add tomato paste 2 min","Deglaze with wine","Add tomatoes, milk, herbs","Lowest simmer 2-3 hours"],
  ...
  {id:24,n:"Creamy Tomato Sausage Sauce",cat:"Pastas",ph:3,tg:["comfort"],
    ...
    ins:["Brown sausage in pieces","Sauté onion, garlic","Add paste, pepper flakes 2 min","Add tomatoes, simmer 20 min","Stir in cream"],
    yi:"~8-10 portions",fr:"Serve over rigatoni or penne"},
  {id:25,n:"Mac and Cheese",cat:"Pastas",ph:3,tg:["comfort"],
    ing:["1 lb pasta (undercook 2 min)","4 tbsp butter, ¼ cup flour","3 cups milk","3 cups sharp cheddar","1 cup gruyère","Mustard powder, paprika"],
  ...
  {id:26,n:"Coconut Lentil Dal",cat:"Dals",ph:4,tg:["gentle","warming"],
    ...
    ins:["Sauté onion golden in ghee","Add garlic, ginger, spices 1 min","Add lentils + liquid, boil","Simmer 20-25 min until broken down","Stir in coconut milk + lemon"],
  ...
  {id:28,n:"Chana Masala",cat:"Dals",ph:4,tg:["warming","hearty"],
    ...
    ins:["Sauté onion deeply golden 10 min","Add garlic, ginger, spices 2 min","Add tomatoes, simmer 10 min","Add chickpeas + water, simmer 20 min","Mash some for creaminess, add lemon"],
  ...
  {id:29,n:"White Bean & Greens Soup",cat:"Dals",ph:4,tg:["gentle"],
    ...
    ins:["Sauté onion, garlic","Add broth, beans, Parm rind, simmer 15 min","Mash some beans for creaminess","Add greens, cook 5 min","Add lemon, season"],
    yi:"~8-10 portions",fr:"Freezes well"},
  {id:30,n:"Vegetable Frittata",cat:"Eggs",ph:4,tg:["protein"],
    ing:["12 eggs","½ cup milk/cream","2 cups mixed veg","1 cup cheese","2 tbsp olive oil","Herbs, salt, pepper"],
    ins:["Sauté vegetables in oven-safe skillet","Pour whisked eggs over, sprinkle cheese","Cook on stove 2-3 min","Oven 375°F 12-15 min until set","Cool, cut wedges"],
    yi:"8 wedges",fr:"Freeze individually wrapped. Toaster oven reheat."},
  {id:31,n:"Quiche",cat:"Eggs",ph:4,tg:["comfort"],
    ing:["1 pie crust","8 eggs","1 cup cream","1½ cups filling (choice)","1 cup gruyère/cheddar","Nutmeg, salt, pepper"],
    ins:["Blind-bake crust 375°F 10 min","Layer filling + cheese","Pour egg-cream mixture over","Bake 35-40 min until golden"],
  ...
  {id:32,n:"Chicken Pot Pie Filling",cat:"Comfort",ph:4,tg:["classic"],
    ...
    ins:["Sauté onion in butter 5 min","Whisk in flour 2 min","Slowly add broth + milk, whisk until thick","Add chicken, veggies, thyme","Cool"],
    yi:"~8 portions",fr:"Freeze filling. Thaw → ramekin → puff pastry top → 400°F 20-25 min"},
  {id:33,n:"Shepherd's Pie",cat:"Comfort",ph:4,tg:["hearty"],
    ...
    ins:["Boil + mash potatoes with butter/milk","Brown meat, sauté veggies","Add paste, broth, Worcestershire, thyme","Simmer 15 min, add peas","Top with mash, optional broil 5 min"],
  ...
  {id:34,n:"Baked Salmon Portions",cat:"Fish",ph:4,tg:["omega-3"],
    ...
    yi:"6-8 portions",fr:"Freeze raw in marinade. Thaw overnight → 400°F 12-15 min."},
  {id:35,n:"Salmon Patties",cat:"Patties",ph:4,tg:["omega-3"],
    ...
    yi:"~10 patties",fr:"Freeze cooked. Toaster oven 350°F 10-12 min."},
  {id:36,n:"Black Bean Patties",cat:"Patties",ph:4,tg:["fiber"],
    ...
    ins:["Mash half, leave half whole","Combine everything","Form patties, chill 30 min","Pan-fry or bake 375°F"],
  ...
  {id:37,n:"White Bean & Herb Patties",cat:"Patties",ph:4,tg:["gentle"],
    ...
    ins:["Mash beans, combine all","Form patties, chill 30 min","Pan-fry or bake 375°F"],
    yi:"~8 patties",fr:"Freeze cooked. Toaster oven reheat."},
  {id:38,n:"Chicken-Veggie Patties",cat:"Patties",ph:4,tg:["protein"],
    ing:["1 lb ground chicken","1 cup grated zucchini (squeeze dry)","½ cup carrots, 2 green onions","1 egg, breadcrumbs, garlic powder"],
  ...
  {id:39,n:"Shredded Chicken (Dark Meat)",cat:"Proteins",ph:3,tg:["iron","versatile"],
    ...
    ins:["Season generously","Roast 425°F 35-40 min OR poach in broth 25-30 min","Shred","Save bones for more broth!"],
  ...
  {id:40,n:"Meatballs (Hidden Liver)",cat:"Proteins",ph:3,tg:["iron","hidden liver"],
    ing:["1.5 lbs ground beef, ½ lb pork","4 oz chicken livers blended","Breadcrumbs, milk, 2 eggs","Onion grated, garlic, Parmesan","Italian seasoning"],
    ins:["Soak breadcrumbs in milk 5 min","Blend livers smooth","Combine gently (don't overwork)","Form 1.5\" balls","Bake 400°F 18-20 min"],
  ...
  {id:41,n:"Carnitas",cat:"Proteins",ph:3,tg:["comfort"],
    ...
    ins:["Season pork all over","Place in Dutch oven with everything","Cover, braise 300°F 3.5-4 hrs","Shred with forks, toss in juices","Optional: broil 5 min for crispy edges"],
  ...
  {id:42,n:"Braised Short Ribs",cat:"Proteins",ph:3,tg:["iron","collagen"],
    ...
    ins:["Sear ribs all sides (take your time)","Sauté veggies, add paste 2 min","Deglaze with wine","Add broth, herbs, return ribs","Cover, braise 325°F 3-3.5 hrs"],
  ...
  {id:44,n:"Mashed Potatoes",cat:"Bases",ph:4,tg:["comfort"],
    ing:["3 lbs Yukon Gold cubed","6 tbsp butter","¾ cup warm milk/cream","Salt, pepper"],
  ...
  {id:46,n:"Polenta",cat:"Bases",ph:4,tg:["comfort"],
    ing:["2 cups polenta","8 cups water/broth","2 tbsp butter, ½ cup Parmesan, salt"],
  ...
  {id:47,n:"Cooked Black Beans",cat:"Bases",ph:4,tg:["fiber"],
    ...
    ins:["Drain, add fresh water + aromatics","Boil → simmer 1-1.5 hrs","Salt last 15 min"],
  ...
  {id:48,n:"Cooked White Beans",cat:"Bases",ph:4,tg:["gentle"],
    ...
    ins:["Drain, add fresh water + aromatics","Boil → simmer 1-1.5 hrs until creamy"],
    yi:"~8 portions",fr:"Freeze 1-cup with some liquid"},
  {id:49,n:"Sauerkraut",cat:"Ferments",ph:1,tg:["gut health","probiotic"],
    ing:["2 heads green cabbage (~5 lbs)","3 tbsp non-iodized salt"],
    ins:["Quarter, core, slice thin","Sprinkle with salt in large bowl","Massage 10-15 min until liquid releases","Pack tightly into jars, submerge in liquid","Fermentation weights on top","Room temp 60-75°F, away from light","Ferment 2-4 weeks, taste weekly","Refrigerate when desired sourness"],
    yi:"~2 quarts",fr:"Do NOT freeze — fridge only. CRITICAL: keep submerged under brine."},
  {id:50,n:"Kimchi",cat:"Ferments",ph:1,tg:["gut health","warming"],
    ing:["2 heads napa cabbage (~4 lbs)","½ cup non-iodized salt, 4 cups water","PASTE: ¼ cup gochugaru, ¼ cup fish sauce, garlic, ginger, sugar, green onions, optional daikon"],
    ins:["Cut cabbage 2\" pieces, soak in salted water 1.5-2 hrs","Rinse 3 times, drain well","Make paste: gochugaru + fish sauce + garlic + ginger + sugar","Toss cabbage with paste + green onions","Pack into jars, 1\" headspace","Ferment room temp 3-7 days","Taste daily, refrigerate when tangy"],
    yi:"~2 quarts",fr:"Do NOT freeze — fridge only. Lasts months."},
];
...
function Rcard({r,open,toggle}){
  return <div className={`border border-gray-200 rounded-lg overflow-hidden ${open?"shadow-md":""}`}>
    <button onClick={toggle} className="w-full text-left px-4 py-3 flex items-center justify-between bg-white hover:bg-gray-50">
      <div className="flex items-center gap-2 min-w-0">
        <span className="text-sm font-medium text-gray-800 truncate">{r.n}</span>
...
export default function App(){
  ...
  // Overview
  const overview=()=>{
    const ph=P.map(p=>{let t=0;p.days.forEach(d=>d.s.forEach(s=>t+=s.t.length));return{...p,total:t,done:cc(`p${p.id}-`)};});
    ...
    return <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm text-gray-600">
          {["42 days for 42 years — recovery in first 6 weeks affects long-term health",
            ...
            "Fermented foods — homemade sauerkraut + kimchi for gut health",
            "TCM + Ayurveda — traditional postpartum nutrition principles"
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex gap-3"><span className="font-medium text-amber-600 w-16">Wk 1</span><span className="text-gray-600">Gentlest: broths, congees, simple soups. Avoid greens.</span></div>
  ...
  const shopping=()=>{
    const ms=[
      {k:"asian",t:"Weee! / Asian Market",cats:SH.asian.map(c=>({...c,items:c.i}))},
  ...
  const phase=(n)=>{
    ...
    let ti=0,tt=0;
    p.days.forEach(d=>d.s.forEach(s=>tt+=s.t.length));
    ...
    return <div className="space-y-6">
      <div className={`${c.bg} ${c.bd} border rounded-xl p-5`}>
        ...
        <Bar done={cc(`p${n}-`)} total={tt}/>
        <p className="text-xs text-gray-500 mt-2">Expected yield: {p.y}</p>
      </div>
      {p.days.map(day=>{
        return <div key={day.d} className="bg-white border border-gray-200 rounded-xl overflow-hidden">
          <div className={`px-4 py-3 ${c.hd} border-b ${c.bd}`}><h3 className="text-sm font-bold text-gray-800">{day.t}</h3></div>
          <div className="px-4 py-2">{day.s.map(sec=><div key={sec.l} className="mb-3">
            <div className="text-xs font-semibold uppercase text-gray-400 mt-2 mb-1">{sec.l}</div>
            {sec.t.map(task=>{const k=`p${n}-${ti}`;ti++;return <Chk key={k} label={task} checked={!!ck[k]} onChange={()=>tg(k)}/>;
            })}
          </div>)}</div>
        </div>;
      })}
      {pr.length>0&&<div>
        <h3 className="text-sm font-bold text-gray-800 mb-3">Phase {n} Recipes</h3>
        <div className="space-y-2">{pr.map(r=><Rcard key={r.id} r={r} open={!!ex[r.id]} toggle={()=>te(r.id)}/>)}</div>
      </div>}
      <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
        <h4 className="text-xs font-semibold uppercase text-gray-500 mb-2">Freezing Workflow</h4>
        <ol className="space-y-1 text-sm text-gray-600">
          {["Cool to room temperature","Ladle into Souper Cubes — leave ¼\" for expansion","Freeze 24 hrs until solid","Pop cubes → labeled freezer bags","Label: NAME + DATE + PORTION SIZE","Reload trays for next batch"].map((x,i)=><li key={i}>{i+1}. {x}</li>)}
        </ol>
      </div>
    </div>;
  };
  ...
  const recipes=()=><div className="space-y-4">
    ...
    <div className="space-y-2">{fr2.map(r=><Rcard key={r.id} r={r} open={!!ex[r.id]} toggle={()=>te(r.id)}/>)}</div>
    <div className="bg-white border border-gray-200 rounded-xl p-5">
      <h3 className="text-sm font-bold text-gray-800 mb-3">Breakfast Ideas</h3>
      {["Egg bites (muffin tins, bake 350°F 20-25 min)","Breakfast burritos (eggs, beans, cheese, salsa — foil-wrap, freeze)","Steel cut oatmeal cups (big batch → muffin tins → freeze)","Savory muffins (zucchini, cheddar, herbs)","Congee (doubles as breakfast)","Mini frittatas (egg + veggies in muffin tins, 375°F 15-18 min)"].map((x,i)=><p key={i} className="text-sm text-gray-600 mb-1">• {x}</p>)}
    </div>
    <div className="bg-white border border-gray-200 rounded-xl p-5">
      ...
      <p className="text-sm text-gray-600">• Chia pudding (¼ cup chia + 1 cup milk + sweetener — fridge overnight, NOT frozen)</p>
    </div>
  </div>;
  ...
  const freezer=()=><div className="space-y-6">
    ...
    {fl.length===0?<div className="text-center py-12 text-gray-400"><p className="text-lg mb-1">Freezer is empty</p><p className="text-sm">Add items as you complete each cooking day</p></div>
    :<div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
    ...
    <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-sm text-gray-600">
        <div><p className="font-medium text-gray-700">Broths/Soups</p><p>Frozen block → saucepan, medium-low, stir. Add water/broth if thick.</p></div>
    ...
    <div className="bg-white border border-gray-200 rounded-xl p-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-gray-600">
        <div><p className="font-medium text-gray-700">Fermented</p><p>Sauerkraut, kimchi, yogurt/kefir, miso</p></div>
