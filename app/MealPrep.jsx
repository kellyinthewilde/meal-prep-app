...
const MEAL_PAIRINGS = {
  ...
  "Bolognese + Meatballs": "Pack with: 1 frozen rice portion (½ cup) OR cook pasta fresh. Meatballs freeze separately.",
  "Minestrone + Meatballs": "Pack soup + meatballs together. Cook pasta fresh when serving.",
